 ...
 */
    [_LOWER] = LAYOUT( \
      ...
      KC_MOUSE, _______, _______, _______, KC_MINS,  _______,                        KC_LCBR, KC_RCBR, _______, _______, _______, _______, \
      _______,  KC_EQL,  KC_UNDS, KC_UNDS, KC_PLUS, _______, KC_MPLY,       _______, KC_LBRC, KC_RBRC, _______, KC_SCLN, KC_COLN, KC_BSLS, \
                         KC_LBRC, _______, _______, _______, _______,       KC_NWIND, _______, _______, _______, KC_RBRC\
    ),
 ...
 */
    [_RAISE] = LAYOUT( \
      ...
      KC_TILDE, KC_INS, KC_PSCR, KC_APP,  XXXXXXX,  XXXXXXX,                          KC_PGUP, KC_PRVWD, KC_UP,   KC_NXTWD, KC_DLINE, KC_BSPC, \
      KC_CAPS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  _______,                          KC_PGDN, KC_LEFT,  KC_DOWN, KC_RGHT,  KC_DEL,   KC_BSPC, \
      _______, KC_UNDO, KC_CUT,  KC_COPY, KC_PASTE, XXXXXXX, KC_MACSLEEP,    _______, XXXXXXX, KC_LSTRT, XXXXXXX, KC_LEND,  XXXXXXX,  _______, \
                        KC_LBRC, _______, _______, _______, KC_NAPP,        _______, _______, _______, _______, KC_RBRC \
    ),
